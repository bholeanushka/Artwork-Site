...
<html>
   ...
   <body>
      ...
      <header id="header" class="alt" >
         <div class="logo"><a href="index.php">The<span>Art Store</span></a></div>
...
<!-- Visit : www.mayurik.com -->
      ...
      <footer id="footer">
         ...
         <div class="copyright">
            <div class="footer text-center">Design & Develop By Artstore.pvt | Visit : www.artstore.com</div>
            &copy; KATK Artwork Online Studio.All rights reserved.
         </div>
      </footer>
      <!-- Scripts -->
